...
if (!empty($_GET)) {
            ...
            if ($_GET["erorr"]=="empty_password_or_email")
             {
                ?>
        ...
        <?php
            ...
            if ($_GET["erorr"]=="not_found")
            {
               ?>
       <div class="alert alert-danger" role="alert">
       Not Found, please verify your email and password
       </div>
       <?php
               # code...
           }
        ...
        <p class="text-center"><em>Login to our website</em></p>
